...
# TODO
parser.add_argument("--train_picture_path_root", type=str, default="/oldhome/peng/dataset/tiny_quickdraw_picture/tiny_train_set/", help="train_sketch_picture_dir")
parser.add_argument("--val_picture_path_root", type=str, default="/oldhome/peng/dataset/tiny_quickdraw_picture/tiny_val_set/", help="val_sketch_picture_dir")
parser.add_argument("--test_picture_path_root", type=str, default="/oldhome/peng/dataset/tiny_quickdraw_picture/tiny_test_set/", help="test_sketch_picture_dir")
parser.add_argument("--sketch_list", type=str, default="/oldhome/peng/dataset/tiny_quickdraw_picture/tiny_train_set.txt", help="sketch_list_urls")
parser.add_argument("--sketch_list_4_val", type=str, default="/oldhome/peng/dataset/tiny_quickdraw_picture/tiny_val_set.txt", help="sketch_list_urls_4_validation")
parser.add_argument("--sketch_list_4_test", type=str, default="/oldhome/peng/dataset/tiny_quickdraw_picture/tiny_test_set.txt", help="sketch_list_urls_4_test")
