...
parser.add_argument("--exp", type=str, default="train_gra_transf_inpt5_new_dropout_2layerMLP_random_attention_mask_early_stop_20percent_002", help="experiment")
...
parser.add_argument("--non_zero_ratio", type=float, default=0.2, help="non_zero_ratio of random attention mask")
...
print("=============\n")
print("non_zero_ratio is :{}".format(args.non_zero_ratio))
print("\n==============")
...
train_dataset = QuickdrawDataset_random_attmask(dataloader_configs['train_coordinate_path_root'], dataloader_configs['sketch_list'], data_dict_4_train, args.non_zero_ratio)
...
val_dataset = QuickdrawDataset_random_attmask(dataloader_configs['val_coordinate_path_root'], dataloader_configs['sketch_list_4_val'], data_dict_4_validation, args.non_zero_ratio)
...
test_dataset = QuickdrawDataset_random_attmask(dataloader_configs['test_coordinate_path_root'], dataloader_configs['sketch_list_4_test'], data_dict_4_test, args.non_zero_ratio)
