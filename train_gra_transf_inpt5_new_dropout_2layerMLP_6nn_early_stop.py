...
from dataloader.QuickdrawDataset4dict_6nn import *
...
parser.add_argument("--exp", type=str, default="train_gra_transf_inpt5_new_dropout_2layerMLP_6nn_early_stop_002", help="experiment")
...
#  002
basic_configs["lr_protocol"] = [(10,0.00005), (20,0.00005 * 0.7), (30,0.00005 * 0.7 * 0.7), (40,0.00005 * 0.7 * 0.7 * 0.7), (50,0.00005 * 0.7 * 0.7 * 0.7 * 0.7), (55,0.00005 * (0.7 ** 5)), (60,0.00005 * (0.7 ** 6)),(65,0.00005 * (0.7 ** 7)),(70,0.00005 * (0.7 ** 8)),(75,0.00005 * (0.7 ** 9)),(80,0.00005 * (0.7 ** 10)),(85,0.00005 * (0.7 ** 11)),(90,0.00005 * (0.7 ** 12)),(95,0.00005 * (0.7 ** 13)),(100,0.00005 * (0.7 ** 14))]
...
train_dataset = QuickdrawDataset_6nn(dataloader_configs['train_coordinate_path_root'], dataloader_configs['sketch_list'], data_dict_4_train)
...
val_dataset = QuickdrawDataset_6nn(dataloader_configs['val_coordinate_path_root'], dataloader_configs['sketch_list_4_val'], data_dict_4_validation)
...
test_dataset = QuickdrawDataset_6nn(dataloader_configs['test_coordinate_path_root'], dataloader_configs['sketch_list_4_test'], data_dict_4_test)
