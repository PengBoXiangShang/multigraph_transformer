...
parser.add_argument("--exp", type=str, default="train_gra_transf_inpt5_new_dropout_2layerMLP_fully_connected_stroke_early_stop_003", help="experiment")
...
train_dataset = QuickdrawDataset_fully_connected_stroke_attmask(dataloader_configs['train_coordinate_path_root'], dataloader_configs['sketch_list'], data_dict_4_train)
...
val_dataset = QuickdrawDataset_fully_connected_stroke_attmask(dataloader_configs['val_coordinate_path_root'], dataloader_configs['sketch_list_4_val'], data_dict_4_validation)
...
test_dataset = QuickdrawDataset_fully_connected_stroke_attmask(dataloader_configs['test_coordinate_path_root'], dataloader_configs['sketch_list_4_test'], data_dict_4_test)
