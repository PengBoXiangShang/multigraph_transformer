...
parser.add_argument("--exp", type=str, default="train_gra_transf_inpt5_new_dropout_2layerMLP_random_attention_mask_early_stop_30percent_003", help="experiment")
...
parser.add_argument("--non_zero_ratio", type=float, default=0.3, help="non_zero_ratio of random attention mask")
