...
from dataloader.QuickdrawDataset4dict_jnn import *
...
parser.add_argument("--exp", type=str, default="train_gra_transf_inpt5_new_dropout_2layerMLP_jnn_early_stop_001", help="experiment")
...
train_dataset = QuickdrawDataset_jnn(dataloader_configs['train_coordinate_path_root'], dataloader_configs['sketch_list'], data_dict_4_train)
...
val_dataset = QuickdrawDataset_jnn(dataloader_configs['val_coordinate_path_root'], dataloader_configs['sketch_list_4_val'], data_dict_4_validation)
...
test_dataset = QuickdrawDataset_jnn(dataloader_configs['test_coordinate_path_root'], dataloader_configs['sketch_list_4_test'], data_dict_4_test)
